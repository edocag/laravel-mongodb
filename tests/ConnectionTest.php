...
class ConnectionTest extends TestCase
{
    public function testConnection()
    {
        ...
        $this->assertInstanceOf('edocag\Mongodb\Connection', $connection);
    }
    ...
    public function testCollection()
    {
        ...
        $this->assertInstanceOf('edocag\Mongodb\Collection', $collection);

        $collection = DB::connection('mongodb')->collection('unittests');
        $this->assertInstanceOf('edocag\Mongodb\Query\Builder', $collection);
    ...
    public function testSchemaBuilder()
    {
        ...
        $this->assertInstanceOf('edocag\Mongodb\Schema\Builder', $schema);
    }
